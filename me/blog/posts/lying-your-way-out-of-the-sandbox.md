...
A few days later, Michal came back with something to show me. It wasn't a sandbox escape, but it was something adjacent, genuinely interesting, and fresh. This blog post is about a refinement and extension of Michal's original attack, together with an (over) abstraction and (over) generalization of the idea behind it.
