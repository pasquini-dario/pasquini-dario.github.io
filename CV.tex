...
\textit{``I spend most of my day either breaking AI models or building AI models to break stuff.}''
...
\item[$\blacktriangle$] Security of LLMs/agents applications \cite{nes, llmmap, aioops}
\item[$\blacktriangle$] LLMs/agents applications to cybersecurity \cite{hackai}
...
\item[[ {02/2026 - Now}]] \textbf{Head of AI}\textbf{:}\\
 \textbf{\textit{Cracken}}\\-\textit{Switzerland}

\item[[ {11/2024 - 01/2026}]] \textbf{Principal Researcher}\textbf{:}\\
 \textbf{\textit{RSAC Labs}}\\
 % --
 %\textbf{Responsibilities:} {Leading research in AI security. Main projects include: (1) discovering vulnerabilities in and hardening Agentic AI for IT Operations (AIOps), and (2) discovering vulnerabilities in Apple Intelligence's on-device LLMs. Also researching and developing production machine-learning systems for RSAC's products.}\\
 -\textit{Switzerland}\\

\item \textcolor{gray}{----------------- academia --------------------------------------------------}\
...
\section*{Worked on:}
\begin{itemize}
\item[$\blacktriangle$] {Security \& Privacy in Collaborative Machine Learning} \cite{dl, CCS21, CCS22}  		
\item[$\blacktriangle$] Password Security \cite{uncm, SP21, adam}
...
\bibitem[USENIX'26]{aioops}
	\textbf{Dario Pasquini},  Evgenios M. Kornaropoulos, Giuseppe Ateniese, Omer Akgul, Athanasios Theocharis and Petros Efstathopoulos. \textit{When AIOps Become "AI Oops": Subverting LLM-driven IT Operations via Telemetry Manipulation} 35th USENIX Security Symposium (USENIX Sec'26), August 2026, Baltimore, MD, USA \url{https://arxiv.org/abs/2508.06394}
